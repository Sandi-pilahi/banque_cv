...
class Etudiant(models.Model):
    ...
    photo = models.ImageField(upload_to='photos/', blank=True, null=False, default='photo.jpg')
    ...
    mot_de_passe = models.CharField(max_length=100)  # Champ pour le mot de passe
